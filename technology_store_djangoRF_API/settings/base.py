"""
Django settings for technology_store_djangoRF_API project.
...
ROOT_URLCONF = 'technology_store_djangoRF_API.urls'
...
WSGI_APPLICATION = 'technology_store_djangoRF_API.wsgi.application'
