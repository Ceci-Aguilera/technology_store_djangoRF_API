...
urlpatterns = [
    ...
    url(r'^manage-address/create/(?P<id>[0-9]+)/$', CreateAddress.as_view(), name='create-address-api'),
    url(r'^user-addresses/$', UserAddressListView.as_view(), name='user-addresses-api'),
